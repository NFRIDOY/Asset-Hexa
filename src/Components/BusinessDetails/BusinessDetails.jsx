...
const BusinessDetails = () => {
    ...
    const { user } = useAuth();
    const [totalInvestments, setTotalInvestment] = useState(business?.totalInvestment)
    ...
    return (
        <div className="max-w-7xl mx-auto px-2">
            <div className=" ">
                <div className="">
                    <img className="md:w-full  rounded-xl h-96 md:h-96 lg:h-[450px]" src={business?.BannerImage} alt="" />
                </div>
                <div className="md:flex md:justify-between  items-center gap-3 ">
                    <div className="flex justify-center items-center">
                        ...
                        <div className="flex items-center mt-3 pl-10 gap-2  ml-5">
                            ...
                            />
                            <div>
                                <p className="font-bold text-xl md:text-2xl">{business?.userName} ({business?.Designation})</p>
                    ...
                    <div>
                        <p className="font-bold text-3xl ">
                            ...
                            <span className="text-[#23A455]"> {totalInvestments}
                            </span>
                        </p>
                    </div>
                </div>
            ...
            <div className="mt-5">
                ...
                <div className="mt-10 pr-3 pl-3 text-justify">
                    ...
                    {isAdmin && <button onClick={handleVerification} className="btn mt-4 bg-gradient-to-r from-[#23A455] via-[#2ecc71] to-[#34D399] hover:border-none  border-none hover:bg-primaryColor  text-white  btn-outline rounded-md">
                        varify this business
                    </button>}
                </div>
                <form onSubmit={handleInvest} className="flex justify-end lg:pr-32 mt-5 ml-10 ">
