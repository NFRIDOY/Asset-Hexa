...
const HowItWorks = () => {
	return (
		<div className="flex md:m-10 lg:md:m-20 flex-col lg:flex-row">
 			<div className="w-full lg:w-1/2 ">
				<img src={image} alt="" />
			</div>
			<div className="w-full md:ml-6 lg:w-1/2 max-w-[555px]">
				...
				<div className="space-y-5 mt-10">
					<div className="flex gap-5">
						...
						<div>
							...
							<p className="text-gray-500">
								Begin your journey by regestering and setting up
								your account
							</p>
						</div>
					</div>
