	...
	return (
		<div>
			<div className="my-6 text-center">
				...
				<p>
					Our team collaborates passionately to achieve excellence in every endeavor.
				</p>
			</div>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-[1200px] mx-auto">
				<div style={{ boxShadow: '#23A455 0px 3px 8px' }} className="card  bg-base-100 m-10 ">
					...
					<div className="card-body items-center text-center">
						...
						<div className=" flex gap-4 mt-5  ">
							...
							<div className="flex text-xl" >
								<a href="https://www.facebook.com/arifulislam.ariful.37/"><FaFacebook
									className="mt-1 text-primaryColor text-black"
									style={30} size={40}
								/></a>
								{/* <span>Facebook</span> */}
							...
							<div className="flex text-xl gap-2">
								<a href="https://www.linkedin.com/in/mai25cse/"><FaLinkedin
									className="mt-1 text-primaryColor text-black"
									style={40} size={40}
								/></a>
								{/* <span>LinkedIn</span> */}
				...
				<div style={{ boxShadow: '#23A455 0px 3px 8px' }} className="card  bg-base-100 m-10 ">
					...
					<div className="card-body items-center text-center">
						...
						<div className=" flex gap-4 mt-5  ">
							...
							<div className="flex text-xl" >
								<a href="https://www.facebook.com/nfridoy/"><FaFacebook
									className="mt-1 text-primaryColor text-black"
									style={30} size={40}
								/></a>
								{/* <span>Facebook</span> */}
							...
							<div className="flex text-xl gap-2">
								<a href="https://linkedin.com/in/nfridoy"><FaLinkedin
									className="mt-1 text-primaryColor text-black"
									style={40} size={40}
								/></a>
								{/* <span>LinkedIn</span> */}
				...
				<div style={{ boxShadow: '#23A455 0px 3px 8px' }} className="card  bg-base-100 m-10 ">
					...
					<div className="card-body items-center text-center">
						...
						<div className=" flex gap-4 mt-5  ">
							...
							<div className="flex text-xl" >
								<a href="https://www.facebook.com/rean.bhuiyan.94"><FaFacebook
									className="mt-1 text-primaryColor text-black"
									style={30} size={40}
								/></a>
								{/* <span>Facebook</span> */}
							...
							<div className="flex text-xl gap-2">
								<a href="https://www.linkedin.com/in/rezuan-alam-rean/"><FaLinkedin
									className="mt-1 text-primaryColor text-black"
									style={40} size={40}
								/></a>
								{/* <span>LinkedIn</span> */}
				...
				<div style={{ boxShadow: '#23A455 0px 3px 8px' }} className="card  bg-base-100 m-10 ">
					...
					<div className="card-body items-center text-center">
						...
						<div className=" flex gap-4 mt-5  ">
							...
							<div className="flex text-xl" >
								<a href="https://www.facebook.com/mdmustafiz.rahman.988/"><FaFacebook
									className="mt-1 text-primaryColor text-black"
									style={30} size={40}
								/></a>
								{/* <span>Facebook</span> */}
							...
							<div className="flex text-xl gap-2">
								<a href="https://www.linkedin.com/in/mustafiz-rahman-8482632a4?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><FaLinkedin
									className="mt-1 text-primaryColor text-black"
									style={40} size={40}
								/></a>
								{/* <span>LinkedIn</span> */}
				...
				<div style={{ boxShadow: '#23A455 0px 3px 8px' }} className="card  bg-base-100 m-10 ">
					...
					<div className="card-body items-center text-center">
						...
						<div className=" flex gap-4 mt-5  ">
							...
							<div className="flex text-xl" >
								<a href="https://www.facebook.com/mehadihasan.mokcadul"><FaFacebook
									className="mt-1 text-primaryColor text-black"
									style={30} size={40}
								/></a>
								{/* <span>Facebook</span> */}
							...
							<div className="flex text-xl gap-2">
								<a href="https://www.linkedin.com/in/mehedi-islam-moksedul-6a83622a4/"><FaLinkedin
									className="mt-1 text-primaryColor text-black"
									style={40} size={40}
								/></a>
								{/* <span>LinkedIn</span> */}
				...
				<div style={{ boxShadow: '#23A455 0px 3px 8px' }} className="card  bg-base-100 m-10 ">
					...
					<div className="card-body items-center text-center">
						...
						<div className=" flex gap-4 mt-5  ">
							...
							<div className="flex text-xl" >
								<a href="https://www.facebook.com/profile.php?id=100009109246385"><FaFacebook
									className="mt-1 text-primaryColor text-black"
									style={30} size={40}
								/></a>
								{/* <span>Facebook</span> */}
							...
							<div className="flex text-xl gap-2">
								<a href="http://www.linkedin.com/in/radiat-hossain-ridoy0"><FaLinkedin
									className="mt-1 text-primaryColor text-black"
									style={40} size={40}
								/></a>
								{/* <span>LinkedIn</span> */}
