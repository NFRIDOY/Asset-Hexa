                ...
                <div className=" p-6 rounded-md bg-gradient-to-tr from-[#8dc487] to-[#b7f4b1f7] transition-all ease-in-out duration-1000 hover:translate-x-24 w-[80%] z-10">
                    <form onSubmit={Blogs}>
                        ...
                        <div className=" mb-2">
                            ...
                            <input name="title" type="text" placeholder="type " className="shadow-xl outline-none input input-bordered input-primary w-full" required/>
                        </div>
                        <div className="mb-2">
                            <label className="label">
                                <span className="label-text text-3xl font-bold text-[#000]">Description </span>
                            </label>
                            <textarea name="description" className="w-full shadow-xl textarea textarea-primary" placeholder="type" required></textarea>
                        </div>
                        <div className=" mb-5">
                            <label className="label">
                                <span className="label-text text-3xl font-bold text-[#000]">Image</span>
                            </label>
                            <input name="image" type="text" placeholder="image url" className="shadow-xl input input-bordered input-primary w-full" required />
                        </div>
