    ...
    <div className=" h-screen  bg-base-300 max-w-screen-2xl  mx-auto">
      <div className="drawer lg:drawer-open  mx-auto bg-white  rounded-2xl min-h-[calc(100vh-32px)]">
        ...
        <div className="drawer-side ">
          ...
          <div className="w-60 h-full  bg-gradient-to-br from-[#23A455] to-[#34D399] justify-between text-white flex flex-col">
            <div>
              ...
              <ul className="menu text-lg  space-y-2 h-fit  rounded-lg mt-4">
                <NavLink
                  className={({ isActive }) =>
                    isActive
                      ? "text-[#23A455] flex px-4 gap-3 items-center bg-white p-2 rounded-xl  pr-4"
