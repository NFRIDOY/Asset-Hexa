                    ...
                    <div className=" p-6 rounded-md bg-gradient-to-tr from-[#8dc487] to-[#b7f4b1f7]">
                        <form onSubmit={handleUpdate}  >
                            ...
                            <div className="flex gap-[49px] mb-5">
                                ...
                                <input defaultValue={Update?.description} name="description" className="w-full hover:drop-shadow-lg hover:border-b-2  hover:border-green-500 rounded  outline-none " type="text" />
                            </div>
                            <div>
                                <button className=" btn w-full text-white bg-[#3EEE2A]">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
